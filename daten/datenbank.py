...
df_p4 = pd.DataFrame({'y': ['Marketing', 'Produktion & Instandhaltung', 'Kundendienst', 'Vertrieb', 'Bereichsübergreifend/(Texte o. Übersetzungen)',
                      'Buchaltung', 'Managementunterstützung/(Strategieentwicklung)', 'IT-Abteilung', 'Logistik', 'Forschung & Entwicklung', 'Personalabteilung',
